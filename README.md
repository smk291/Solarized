...
Solarized Mono modifies the Sublime Text 3 Solarized color scheme so that text is rendered in just two colors: a background color and a foreground color.
